...
class Ragsoc(models.Model):
    ...
    sesso = models.CharField(max_lenght=1, null=True, blank=True)
    datnas = models.DateField(null=True, blank=True)
    comnas = models.CharField(max_lenght=50, null=True, blank=True)
    pronas = models.CharField(max_lenght=2, null=True, blank=True)
    cognom = models.CharField(max_lenght=50, null=True, blank=True)
    nome = models.CharField(max_lenght=50, null=True, blank=True)
    tipsog = models.CharField(max_lenght=2)
    tipcon = models.CharField(max_lenght=1)
    tipiva = models.CharField(max_lenght=1)
    banapp = models.CharField(max_lenght=50, null=True, blank=True)
    iban = models.CharField(max_lenght=27, null=True, blank=True)
    cofiin = models.CharField(max_lenght=16, null=True, blank=True)
    iscain = models.CharField(max_lenght=5, null=True, blank=True)
    compre = models.CharField(max_lenght=1, null=True, blank=True)
    cofiso = models.CharField(max_lenght=16, null=True, blank=True)
    codatt = models.CharField(max_lenght=6, null=True, blank=True)
