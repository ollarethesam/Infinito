...
class Movmag(models.Model):
    ...
    nuorfo = models.ForeignKey(Ordfor, to_field='nuorfo', on_delete=models.CASCADE, null=True, blank=True)
    nuorcl = models.ForeignKey(Ordcli, to_field='nuorcl', on_delete=models.CASCADE, null=True, blank=True)
    anorfo = models.ForeignKey(Ordfor, to_field='anorfo', on_delete=models.CASCADE, null=True, blank=True)
    anorcl = models.ForeignKey(Ordcli, to_field='anorcl', on_delete=models.CASCADE, null=True, blank=True)
    nuorpr = models.ForeignKey(Ordpro, to_field='nuorpr', on_delete=models.CASCADE, null=True, blank=True)
    anorpr = models.ForeignKey(Ordpro, to_field='anorpr', on_delete=models.CASCADE, null=True, blank=True)
