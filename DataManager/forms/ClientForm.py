...
class ClientForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'codcli' : forms.TextInput(attrs={'class':'codcli form-control pk l3', 'autocomplete': 'off', 'id': False}),
            'ragsoc' : forms.TextInput(attrs={'class':'ragsoc form-control', 'autocomplete': 'off', 'id': False}),
            ...
            'locali' : forms.TextInput(attrs={'class':'locali form-control medium', 'autocomplete': 'off', 'id': False}),
            'provin' : forms.TextInput(attrs={'class':'provin form-control l2', 'autocomplete': 'off', 'id': False}),
            'cap'    : forms.TextInput(attrs={'class':'cap form-control l3', 'autocomplete': 'off', 'id': False}),
            'rssped' : forms.TextInput(attrs={'class':'rssped form-control', 'autocomplete': 'off', 'id': False}),
            ...
            'losped' : forms.TextInput(attrs={'class':'losped form-control medium', 'autocomplete': 'off', 'id': False}),
            'prsped' : forms.TextInput(attrs={'class':'prsped form-control l2', 'autocomplete': 'off', 'id': False}),
            'capspe' : forms.TextInput(attrs={'class':'capspe form-control l3', 'autocomplete': 'off', 'id': False}),
            'telefo' : forms.TextInput(attrs={'class':'telefo form-control', 'autocomplete': 'off', 'id': False}),
            'cellul' : forms.TextInput(attrs={'class':'cellul form-control', 'autocomplete': 'off', 'id': False}),
            'telef1' : forms.TextInput(attrs={'class':'telef1 form-control', 'autocomplete': 'off', 'id': False}),
            'fax'    : forms.TextInput(attrs={'class':'fax form-control', 'autocomplete': 'off', 'id': False}),
            ...
            'codfis' : forms.TextInput(attrs={'class':'codfis form-control', 'autocomplete': 'off', 'id': False}),
            'pariva' : forms.TextInput(attrs={'class':'pariva form-control', 'autocomplete': 'off', 'id': False}),
            'banapp' : forms.TextInput(attrs={'class':'banapp form-control', 'autocomplete': 'off', 'id': False}),
            'fido'   : forms.NumberInput(attrs={'class':'fido form-control medium', 'autocomplete': 'off','step':'0.01', 'id': False}),
            'codpag' : forms.TextInput(attrs={'class':'codpag form-control fk short', 'autocomplete': 'off', 'id': False}),
            'codzon' : forms.TextInput(attrs={'class':'codzon form-control fk short', 'autocomplete': 'off', 'id': False}),
            'sconto' : forms.NumberInput(attrs={'class':'sconto form-control short', 'autocomplete': 'off','step':'0.01', 'id': False}),
            'codiva' : forms.TextInput(attrs={'class':'codiva form-control fk short', 'autocomplete': 'off', 'id': False}),
            'codese' : forms.TextInput(attrs={'class':'codese form-control fk short', 'autocomplete': 'off', 'id': False}),
            'codcab' : forms.TextInput(attrs={'class':'codcab form-control short', 'autocomplete': 'off', 'id': False}),
            'codabi' : forms.TextInput(attrs={'class':'codabi form-control short', 'autocomplete': 'off', 'id': False}),
            'codval' : forms.TextInput(attrs={'class':'codval form-control fk short', 'autocomplete': 'off', 'id': False}),
            'codnaz' : forms.TextInput(attrs={'class':'codnaz form-control fk short', 'autocomplete': 'off', 'id': False}),
            ...
            'cin'    : forms.TextInput(attrs={'class':'cin form-control l2', 'autocomplete': 'off', 'id': False}),
            'conto'  : forms.TextInput(attrs={'class':'conto form-control medium', 'autocomplete': 'off', 'id': False}),
            'codcat' : forms.TextInput(attrs={'class':'codcat form-control fk short', 'autocomplete': 'off', 'id': False}),
            ...
            'nome'   : forms.TextInput(attrs={'class':'nome form-control medium', 'autocomplete': 'off', 'id': False}),
            ...
            'codban' : forms.TextInput(attrs={'class':'codban form-control fk short', 'autocomplete': 'off', 'id': False}),
            'staest' : forms.TextInput(attrs={'class':'staest form-control short', 'autocomplete': 'off', 'id': False}),
            'cognom' : forms.TextInput(attrs={'class':'cognom form-control medium', 'autocomplete': 'off', 'id': False}),
            'comnas' : forms.TextInput(attrs={'class':'comnas form-control medium', 'autocomplete': 'off', 'id': False}),
            'pronas' : forms.TextInput(attrs={'class':'pronas form-control medium', 'autocomplete': 'off', 'id': False}),
