...
class FornitForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'codpag': forms.TextInput(attrs={'class':'codpag Modpag form-control fk l4', 'autocomplete': 'off', 'id': False}),
            ...
            'codnaz': forms.TextInput(attrs={'class':'codnaz Nazion form-control fk l3', 'autocomplete': 'off', 'id': False}),
            'codiva': forms.TextInput(attrs={'class':'codiva Ivaacq form-control fk l2', 'autocomplete': 'off', 'id': False}),
            'codcat': forms.TextInput(attrs={'class':'codcat Catego form-control fk l3', 'autocomplete': 'off', 'id': False}),
