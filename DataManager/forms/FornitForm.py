...
class FornitForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'locali': forms.TextInput(attrs={'class':'locali form-control long', 'autocomplete': 'off', 'id': False}),
            ...
            'telef2': forms.TextInput(attrs={'class':'telef2 form-control', 'autocomplete': 'off', 'id': False}),
            ...
            'conto' : forms.TextInput(attrs={'class':'conto form-control', 'autocomplete': 'off', 'id': False}),
            'codabi': forms.TextInput(attrs={'class':'codabi form-control l3', 'autocomplete': 'off', 'id': False}),
            'codcab': forms.TextInput(attrs={'class':'codcab form-control l3', 'autocomplete': 'off', 'id': False}),
