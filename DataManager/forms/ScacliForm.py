...
class ScacliForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'datdoc': forms.DateInput(format='%d-%m-%Y', attrs={'type':'date', 'class':'datdoc form-control', 'autocomplete': 'off', 'id': False}),
            ...
            'datsca': forms.DateInput(format='%d-%m-%Y', attrs={'type':'date', 'class':'datsca form-control l35', 'autocomplete': 'off', 'id': False}),
