...
class PiaconForm(ModelForm):
    ...
    codcon = forms.CharField(required = False,label='Contropartia Abituale', widget=forms.TextInput(attrs={'class':'codcon Conabi form-control l9', 'autocomplete': 'off', 'readonly': True, 'id': False}))
    descon = forms.CharField(required = False,label='Descrizione', widget=forms.TextInput(attrs={'class':'descon Conabi form-control l30', 'autocomplete': 'off', 'readonly': True, 'id': False}))
    class Meta:
        model = Piacon
        ...
        widgets = {
            'codpia': forms.TextInput(attrs={'class':'codpia Piacon form-control pk l9', 'autocomplete': 'off', 'id': False}),
            'despia': forms.TextInput(attrs={'class':'despia Piacon form-control l30', 'autocomplete': 'off', 'id': False}),
        }
