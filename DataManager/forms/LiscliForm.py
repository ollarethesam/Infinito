...
class LiscliForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'codcli': forms.TextInput(attrs={'class':'codcli Client form-control pk l3 main', 'autocomplete': 'off', 'id': False}),
            'codart': forms.TextInput(attrs={'class':'codart Artico form-control pk medium', 'autocomplete': 'off', 'id': False}),
