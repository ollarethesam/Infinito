...
from DataManager.forms.IvacorForm import IvacorForm
from DataManager.models.ivacor import Ivacor
from django.shortcuts import get_object_or_404
from ..functions import *

def ivacor(request, model=Ivacor, modelform=IvacorForm, template='DataManager/mainform.html', url_name='ivacor'):
