...
from DataManager.forms.IvavenForm import IvavenForm
from DataManager.models.ivaven import Ivaven
from django.shortcuts import get_object_or_404
from ..functions import *

def ivaven(request, model=Ivaven, modelform=IvavenForm, template='DataManager/mainform.html', url_name='ivaven'):
